...
This repository is no longer being maintained.  With larger scale Seq instances, the constantly growing column structure lacked in performance and became too much to maintain.  The new repository for this project is [Seq.App.SQLServerExporter](https://github.com/johnmiller86/Seq.App.SQLServerExporter)
